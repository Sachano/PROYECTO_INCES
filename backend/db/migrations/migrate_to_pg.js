...
async function migrate() {
  ...
  const isSslNeeded = connectionString && (connectionString.includes('sslmode=require') || connectionString.includes('neon.tech'))
  const pool = connectionString
    ? new Pool({ connectionString, ssl: isSslNeeded ? { rejectUnauthorized: false } : undefined })
    : new Pool({
