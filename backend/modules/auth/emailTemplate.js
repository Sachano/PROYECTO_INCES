export function buildInvitationEmail({ logoUrl, completeLink, siteName = 'INCES', userName = 'Usuario', enrollment = '' }){
  return `
<!DOCTYPE html>
<html>
<head>
    ...
    <tr>
      <td align="center">
          ...
          <tr>
            <td style="padding:40px 30px;">
              <h1 style="color:#1a1a2e;font-size:24px;font-weight:600;margin:0 0 20px 0;text-align:center;">
                Has sido invitado al INCES
              </h1>
              <p style="color:#4a4a4a;font-size:16px;line-height:1.6;margin:0 0 20px 0;">
                Hola <strong>${userName}</strong>,
              </p>
              <p style="color:#4a4a4a;font-size:16px;line-height:1.6;margin:0 0 20px 0;">
                Un administrador te ha invitado a formar parte de <strong>${siteName}</strong>.
                Para completar tu registro y acceder al sistema, solo debes establecer tu contraseña haciendo clic en el botón de abajo.
              </p>
              ${enrollment ? `
              <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#f8f9fa;border-radius:8px;border:1px solid #e9ecef;margin:20px 0;">
                <tr>
                  <td style="padding:20px;text-align:center;">
                    <p style="color:#4a4a4a;font-size:14px;margin:0 0 5px 0;">Tu matrícula será:</p>
                    <p style="color:#e94560;font-size:22px;font-weight:bold;margin:0;">${enrollment}</p>
                  </td>
                </tr>
              </table>
              ` : ''}
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center">
                    <a href="${completeLink}" style="display:inline-block;background:linear-gradient(135deg, #e94560 0%, #c72c41 100%);color:#ffffff;text-decoration:none;padding:16px 32px;border-radius:8px;font-size:16px;font-weight:600;box-shadow:0 4px 12px rgba(233,69,96,0.3);">
          ...
          <tr>
            <td style="background-color:#f8f9fa;padding:20px 30px;text-align:center;border-top:1px solid #eeeeee;">
              <p style="color:#999999;font-size:12px;margin:0;">
                Este correo fue enviado automáticamente por <strong>${siteName}</strong>.
              </p>
            </td>
          </tr>
        </table>
        <p style="color:#999999;font-size:12px;margin:20px 0 0 0;text-align:center;">
          ...
          <a href="${completeLink}" style="color:#e94560;">${completeLink}</a>
        </p>
      </td>
    </tr>
  </table>
...
export function buildVerificationEmail({ logoUrl, verifyLink, siteName = 'INCES', userName = 'Usuario' }){
  return `
<!DOCTYPE html>
<html>
<head>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#f5f5f5;padding:20px 0;">
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,0.1);overflow:hidden;">
          ...
          <tr>
            <td style="padding:40px 30px;">
              ...
              <p style="color:#4a4a4a;font-size:16px;line-height:1.6;margin:0 0 30px 0;">
                Gracias por registrarte en <strong>${siteName}</strong>. Por favor confirma tu dirección de correo electrónico haciendo clic en el botón de abajo.
              </p>
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center">
                    <a href="${verifyLink}" style="display:inline-block;background:linear-gradient(135deg, #e94560 0%, #c72c41 100%);color:#ffffff;text-decoration:none;padding:16px 32px;border-radius:8px;font-size:16px;font-weight:600;box-shadow:0 4px 12px rgba(233,69,96,0.3);">
                      Verificar mi correo
                    </a>
                  </td>
                </tr>
        ...
        <p style="color:#999999;font-size:12px;margin:20px 0 0 0;text-align:center;">
          Si el botón no funciona, copia y pega este enlace:<br/>
          <a href="${verifyLink}" style="color:#e94560;">${verifyLink}</a>
        </p>
      </td>
    </tr>
  </table>
